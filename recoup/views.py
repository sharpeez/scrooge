...
def DUCReport(request):
    ...
    with xlsxwriter.Workbook(response, {'in_memory': True}) as workbook:
        ...
        itsystems.write_row("A1", ("Division / Cost Centre", "IT System", "Cost", "% Total"))
        ...
        invoice.write_row("A1", ("Division / Cost Centre", "IT User Accounts", "End User Services", "Business IT Systems", "Total DUC Cost"))
